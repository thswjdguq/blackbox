...
- [x] 필터 (담당자/태그/우선순위) — 필터 바 + 칩 선택, 초기화 버튼
...
> **⚠️ 전략 전환 (2026-03-30):** 교수 전용 실시간 대시보드 폐기.
> 학생 프라이버시 보호 및 Hash Vault 철학(불변성·증거력)과의 일관성을 위해
> **SHA-256 무결성 PDF 보고서를 교수에게 제출하는 방식으로 전환.**
> 아래 "교수 대시보드" 관련 항목은 구현하지 않음.
